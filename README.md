...
* Moderate positive correlations were observed between several selected brain regions
* Exploratory connectivity structure was visible across ROI pairs in the correlation matrix
* Visualizations were broadly consistent with expected resting-state network organization in a proof-of-concept setting
